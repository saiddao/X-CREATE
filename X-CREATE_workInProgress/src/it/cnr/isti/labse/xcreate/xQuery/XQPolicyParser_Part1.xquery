		...
		then <caso2>{	for $attD in $apply/child::*
			...
			then <caso3>{local:makeTuple(local:extractAD($apply/Apply), $apply/child::AttributeValue)}</caso3>
				...
				then <caso5>{
					...
					then <caso7>{
							local:makeTuple(local:extractAD($apply), local:makeAttributeValue('caso7'))
							}</caso7>
...
then <Function Caso ="Caso1" Function = "{data($node/Function/@FunctionId)}">{
		local:makeTuple(local:extractAD($node), $node/child::AttributeValue)
	}</Function>
else (:Caso 2:)
	if(local:caso2($node))
	then <Function Caso ="Caso2" Function = "{data($node/Function/@FunctionId)}">{
			for $attD in $node/child::*
			where fn:contains(local-name($attD), 'AttributeDesignator')
			return 	local:makeTuple($attD, local:makeAttributeValue('caso2'))
		}</Function>
	else (:Caso 3:) if(local:caso3($node))
		then <Function Caso ="Caso3" Function = "{data($node/Function/@FunctionId)}">{
				local:makeTuple(local:extractAD($node/Apply), $node/child::AttributeValue)
			}</Function>
		else (:Caso 4:) if(local:caso4($node))
					then <Function Caso ="Caso4" Function = "{data($node/Function/@FunctionId)}">{
						local:makeTuple(local:extractAD($node), $node/Apply/child::AttributeValue)
						}</Function>
					else (:Caso 5:) if(local:caso5($node))
					then <Function Caso ="Caso5" Function = "{data($node/Function/@FunctionId)}">{
							...
							then <Function Caso ="Caso6" Function = "{data($node/Function/@FunctionId)}">{
...
declare function local:makeAttributeValue(){<AttributeValue>caso2</AttributeValue>};
...
(:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    SOLO QUETI NODI HANNO COME FIGLIO DIRETTO UN NODO TARGET
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::)
